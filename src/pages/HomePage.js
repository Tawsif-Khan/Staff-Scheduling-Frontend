...
//Staff Scheduler pages

import AddStaffForm from "./staff/AddStaffForm";
import StaffList from "./staff";
import EditStaff from "./staff/EditStaffForm";
...
export default () => (
  <Switch>
    ...
    <RouteWithSidebar
      exact
      path={Routes.AddStaffForm.path}
      component={AddStaffForm}
    />
    <RouteWithSidebar
      exact
      path={Routes.StaffList.path}
      component={StaffList}
    />
    <RouteWithSidebar
      exact
      path={Routes.GenerateSchedule.path}
      component={GenerateSchedule}
    />
    <RouteWithSidebar
      exact
      path={Routes.EditStaff.path}
      component={EditStaff}
    />
    <RouteWithSidebar exact path={Routes.Demand.path} component={Demand} />
